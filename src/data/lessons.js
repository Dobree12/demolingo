...
export const lessons = [
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { de: 'Guten Tag', ro: 'Bună ziua', example: 'Guten Tag, Herr Müller!', exampleRo: 'Bună ziua, domnul Müller!' },
      ...
      { de: 'Tschüss', ro: 'Pa / La revedere', example: 'Tschüss! Bis morgen!', exampleRo: 'Pa! Pe mâine!' },
      { de: 'Auf Wiedersehen', ro: 'La revedere (formal)', example: 'Auf Wiedersehen, Frau Schmidt!', exampleRo: 'La revedere, doamna Schmidt!' },
      { de: 'Danke', ro: 'Mulțumesc', example: 'Danke schön!', exampleRo: 'Mulțumesc frumos!' },
      { de: 'Bitte', ro: 'Te rog / Cu plăcere', example: 'Bitte schön!', exampleRo: 'Cu plăcere!' },
      { de: 'Ja', ro: 'Da', example: 'Ja, natürlich!', exampleRo: 'Da, desigur!' },
    ...
    exercises: [
      ...
      { type: 'translate_de_ro', prompt: 'Tschüss', answer: 'Pa' , alts: ['La revedere'] },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { de: 'heiße', ro: 'mă numesc', example: 'Ich heiße Anna.', exampleRo: 'Mă numesc Anna.' },
      { de: 'Wie heißt du?', ro: 'Cum te numești?', example: 'Hallo! Wie heißt du?', exampleRo: 'Bună! Cum te numești?' },
      ...
      { de: 'Ich komme aus', ro: 'Eu vin din / Sunt din', example: 'Ich komme aus Rumänien.', exampleRo: 'Eu sunt din România.' },
      { de: 'Rumänien', ro: 'România', example: 'Ich komme aus Rumänien.', exampleRo: 'Eu vin din România.' },
      { de: 'Deutschland', ro: 'Germania', example: 'Deutschland ist schön.', exampleRo: 'Germania e frumoasă.' },
    ],
    exercises: [
      { type: 'multiChoice', question: 'Cum spui "Eu sunt" în germană?', correct: 'Ich bin', options: ['Ich bin', 'Du bist', 'Ich heiße', 'Ich komme'] },
      { type: 'translate_ro_de', prompt: 'Mă numesc Anna', answer: 'Ich heiße Anna' },
      { type: 'listen', word: 'Wie heißt du?', answer: 'Wie heißt du' },
      { type: 'fillBlank', sentence: 'Ich _____ aus Rumänien.', answer: 'komme', hint: 'Eu vin din România' },
      ...
      { type: 'speak', word: 'Ich heiße', translation: 'Mă numesc' },
      { type: 'translate_de_ro', prompt: 'Wie geht es dir?', answer: 'Ce mai faci?', alts: ['Ce mai faci', 'Cum te simți'] },
      { type: 'multiChoice', question: 'Cum spui "România" în germană?', correct: 'Rumänien', options: ['Rumänien', 'Deutschland', 'Österreich', 'Russland'] },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { de: 'drei', ro: 'trei (3)', example: 'Ich habe drei Bücher.', exampleRo: 'Am trei cărți.' },
      { de: 'vier', ro: 'patru (4)', example: 'Vier Jahreszeiten.', exampleRo: 'Patru anotimpuri.' },
      { de: 'fünf', ro: 'cinci (5)', example: 'Fünf Minuten, bitte.', exampleRo: 'Cinci minute, vă rog.' },
    ...
    exercises: [
      ...
      { type: 'multiChoice', question: 'Cum spui "cinci" în germană?', correct: 'fünf', options: ['vier', 'fünf', 'sechs', 'drei'] },
      ...
      { type: 'speak', word: 'fünf', translation: 'cinci' },
      { type: 'multiChoice', question: 'Ce înseamnă "neun"?', correct: 'nouă', options: ['opt', 'nouă', 'zece', 'șase'] },
      { type: 'match', pairs: [['fünf', 'cinci'], ['sechs', 'șase'], ['sieben', 'șapte'], ['acht', 'opt']] },
  ...
  // ==========================================
  {
    ...
    unit: 4,
    words: [
      { de: 'die Mutter', ro: 'mama', example: 'Meine Mutter heißt Elena.', exampleRo: 'Mama mea se numește Elena.' },
      ...
      { de: 'der Bruder', ro: 'fratele', example: 'Mein Bruder spielt Fußball.', exampleRo: 'Fratele meu joacă fotbal.' },
      { de: 'die Großmutter', ro: 'bunica', example: 'Meine Großmutter kocht gut.', exampleRo: 'Bunica mea gătește bine.' },
      { de: 'der Großvater', ro: 'bunicul', example: 'Mein Großvater liest gern.', exampleRo: 'Bunicul meu citește cu plăcere.' },
      ...
      { de: 'der Mann', ro: 'soțul / bărbatul', example: 'Der Mann ist groß.', exampleRo: 'Bărbatul este înalt.' },
      { de: 'die Frau', ro: 'soția / femeia', example: 'Die Frau ist Ärztin.', exampleRo: 'Femeia este doctoriță.' },
    ],
    exercises: [
      ...
      { type: 'translate_ro_de', prompt: 'bunica', answer: 'die Großmutter' },
      { type: 'listen', word: 'der Bruder', answer: 'der Bruder' },
      { type: 'fillBlank', sentence: 'Mein _____ spielt Fußball.', answer: 'Bruder', hint: 'Fratele meu joacă fotbal' },
      ...
      { type: 'match', pairs: [['die Großmutter', 'bunica'], ['der Großvater', 'bunicul'], ['das Kind', 'copilul'], ['die Eltern', 'părinții']] },
      ...
      { type: 'listen', word: 'die Großmutter', answer: 'die Großmutter' },
    ],
  },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { de: 'der Tee', ro: 'ceaiul', example: 'Möchtest du Tee?', exampleRo: 'Vrei ceai?' },
      { de: 'der Apfel', ro: 'mărul', example: 'Der Apfel ist rot.', exampleRo: 'Mărul este roșu.' },
      { de: 'die Suppe', ro: 'supa', example: 'Die Suppe ist heiß.', exampleRo: 'Supa este fierbinte.' },
      { de: 'das Fleisch', ro: 'carnea', example: 'Ich esse kein Fleisch.', exampleRo: 'Eu nu mănânc carne.' },
      { de: 'der Käse', ro: 'brânza', example: 'Ich mag Käse.', exampleRo: 'Îmi place brânza.' },
      { de: 'essen', ro: 'a mânca', example: 'Was möchtest du essen?', exampleRo: 'Ce vrei să mănânci?' },
      { de: 'trinken', ro: 'a bea', example: 'Was möchtest du trinken?', exampleRo: 'Ce vrei să bei?' },
    ],
    exercises: [
      ...
      { type: 'match', pairs: [['der Tee', 'ceaiul'], ['die Suppe', 'supa'], ['der Käse', 'brânza'], ['das Fleisch', 'carnea']] },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { de: 'grün', ro: 'verde', example: 'Das Gras ist grün.', exampleRo: 'Iarba este verde.' },
      ...
      { de: 'weiß', ro: 'alb', example: 'Der Schnee ist weiß.', exampleRo: 'Zăpada este albă.' },
    ...
    exercises: [
      ...
      { type: 'multiChoice', question: 'Cum spui "verde" în germană?', correct: 'grün', options: ['gelb', 'blau', 'grün', 'rot'] },
      { type: 'match', pairs: [['rot', 'roșu'], ['blau', 'albastru'], ['grün', 'verde'], ['gelb', 'galben']] },
      ...
      { type: 'speak', word: 'grün', translation: 'verde' },
      { type: 'translate_de_ro', prompt: 'weiß', answer: 'alb' },
      { type: 'match', pairs: [['schwarz', 'negru'], ['weiß', 'alb'], ['braun', 'maro'], ['rosa', 'roz']] },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { de: 'die Katze', ro: 'pisica', example: 'Die Katze schläft.', exampleRo: 'Pisica doarme.' },
      ...
      { de: 'der Bär', ro: 'ursul', example: 'Der Bär ist groß.', exampleRo: 'Ursul este mare.' },
    ...
    exercises: [
      ...
      { type: 'multiChoice', question: 'Cum spui "vulpea" în germană?', correct: 'der Fuchs', options: ['der Bär', 'der Fuchs', 'die Maus', 'der Hund'] },
      { type: 'speak', word: 'die Katze', translation: 'pisica' },
      { type: 'translate_de_ro', prompt: 'das Schwein', answer: 'porcul', alts: ['porc'] },
      { type: 'match', pairs: [['das Pferd', 'calul'], ['die Kuh', 'vaca'], ['der Bär', 'ursul'], ['der Fuchs', 'vulpea']] },
